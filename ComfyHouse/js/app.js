...
*Version:                                         *1.0
*Date Last Modified:                              *11/30/20
*Modified by:                                     *Joshua Milbourne
*Modification log:                                *

      Version 1.0    11/30/20  Joshua Milbourne    Created JS doc from proposed design documents
...
const continueShoppingBtn = document.querySelector(".continue-cart");
...
class Products {
  async getProducts() {
    try {
      ...
      // destructure JSON objects to clean array objects
...
class UI {
  ...
  checkout() {
    cartOverlay.classList.remove("transparentBcg");
    cartDOM.classList.remove("showCart");
    // checkoutTotal.innerText("cartTotal");
  }
  removeItem(id) {
